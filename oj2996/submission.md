...
```text
โจทย์ให้รับชื่อมา5ตัว และสลับตัวทั้งหมด และคำตอบเป็นพิมพ์เล็ก

input:
กำหนดตัวแปลรับค่ามา

output:
inputที่ใส่มา5ตัว กลับตัวอักษรทั้งหมด และ พิมพ์เล็ก

constraints:
รับมาต้องยาว5ตัวอักษร
ข้อความที่ออกต้องเป็นพิมพ์เล็ก
```
...
```text
step1: รับค่ามาก่อน
step2: เอาเข้าเงื่อนไข 5 ตัว
step3: ทำให้ตัวอักษรสลับกัน
step4: แสดงผลออกมาให้เป็นพิมพ์เล็ก
```
...
```text
ใช้เหมือนกับแผนแรกเลย เพราะเป็นไปตามที่คิดไว้และคำตอบออกมาถูก
```
...
```text
เพราะเป็นตัวอย่างที่โจทย์ให้ ถ้าตัวอย่างผิด ตัวที่เอามาเองก็ผิด
```
...
```text
ต้องลองที่เอามาเองดูสักอันว่าจะถูกมั้ย
```
...
```text
บอกว่าสลับตัวต้องทำยังไง
```

คุณยังทำอะไรด้วยตนเอง

```text
นำสิ่งที่googleบอกว่าใส่ในcode และเขียนเองต่อ
```
