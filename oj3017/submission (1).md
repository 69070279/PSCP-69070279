...
```text
โจทย์ให้คิดตังลูกโดยมีค่าsurviceขึ้นกับค่าอาหาร และ vat

input:
รับค่าราคาของอาหารหรือน้ำ

output:
ราคาที่ต้องจ่ายเมื่อคิดค่าทุกอย่างแล้ว

Constraints:
ค่าsurvice จะไม่ต่ำกว่า50และมากกว่า1000
```
...
```text
step1: รับราคาของอาหารก่อน
step2: คิดค่าsurvice ก่อนเพื่อให้ง่ายต่อการคิดต่อ
step3: กำหนดเงื่อนไขค่าsurvice ที่ไม่มากกว่า1000หรือน้อยกว่า50
step4: คิดราคาที่รวมค่าอาหารหรือน้ำกับค่า survice
step5: คิดvat7%ของราคารวมก่อนหน้า
step6: แสดงผลออกมาโดยให้แสดงถึงแค่ทศนิยม2ตำแหน่ง
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก เพราะการใส่ที่ละอย่างช่วยทำให้คิดออกมาได้ง่ายขึ้นและไม่ผิดพลาดอีกด้วย
```
...
```text
เพราะเป็นตัวอย่างที่โจทย์ให้มา
```
