...
```text
โจทย์ต้องการให้แปลค่าจากอุณหภูมิหนึ่งเป็นอีกอุณหภูมิหนึ่ง

Input:
ค่าของอุณหภูมิ
หน่วยองศาแรกที่รับมา
หน่วยองศาที่จะเปลี่ยนเป็น
Output:
ค่าของอุณหภูมิที่องศาใหม่

Constraints:
input1 เป้น float
outputเป็นเลขทศนิยม2ตำแหน่ง
```
...
```text
Step 1: รับค่าต่างๆมาจากinput
Step 2: แปลค่าทุกอย่างให้อยู่ในหน่วยองศาเซลเซียส
Step 3: นำไปคำนวณกับสูตรที่โจทย์ให้
Step 4: แสดงoutputเป็นเลขทศนิยม2ตำแหน่ง

ก่อนถามเพื่อน ฉันรู้อยู่แล้วว่าควร ตั้งเงื่อนไขให้ค่าต่างๆเข้าด้วยกัน 
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันใช้ การแปลงค่า และคำนวณต่อ จากนั้นจึงได้คำตอบ
```
...
```text
เขาแนะนำว่า หากนำค่าที่ไม่ใช่องศาเซลเซียสแปลงเป้นองศาเซลเซียสก่อน จะง่ายกว่า
```

คุณยังทำอะไรด้วยตนเอง

```text
หลังจากนั้นผมก็ทำตามที่เพื่อนแนะนำและเขียนโค้ดเองทุกอย่าง
```
