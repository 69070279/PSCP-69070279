...
```text
โจทย์ให้ฉันดูคะแนนจากคน3คนโดยที่จะบอกแค่ผลรวบกับค่าสูงสุด

Input:
ผลรวมและค่าสูงสุด

Output:
แสดงว่า น่าสงสัย หรือ ไม่น่าสงสัย

Constraints:
ค่ามากสุดจากการโหวตจะไม่เกิน10
หากค่ามากสุดกับน้อยสุดต่างกันเกิน2จะถือว่าน่าสงสัย
```
...
```text
Step 1: ตั้งinputให้รับค่าสองค่าคนละบรรทัด
Step 2: ตั้งสมมุติฐานว่าค่ามากสุดนั้นมีสองค่า
Step 3: ลองเอาค่านั้นไปลบกับผลรวม
Step 4: นำเข้าเงื่อนไขห่างกัน2 ถ้าจริงก็น่าสงสัย
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก โดยการตั้งสมมุติฐานให้มีค่าสองค่า และถ้าหากมันหากกันจริงๆ มันก็ต้องน่าสงสัย
```
...
```text
เพื่อลองดูว่าจะออกมาตามที่โจทย์ตั้งไว้มั้ย
```
...
```text
อธิบายหลักการว่าทำไมถึงต้องตั้งสมมุติฐานให้มีค่ามากสุด2อัน
```

คุณยังทำอะไรด้วยตนเอง

```text
ทำความเข้าใจกับคำอธิบายของเพื่อน เพราะเราจำเป็นต้องหาโอกาสที่ค่ามากสุดจะมี2ค่าเพื่อให้เราไปหาอีกค่าหนึ่งได้ หลังจากนั้นก็เริ่มเขียนสูตร
```
