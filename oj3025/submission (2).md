...
```text
โจทย์ให้ตั้งเงื่อนไขในการเปลี่ยนฤดูกาล
...
```text
step 1:ตั้งตัวแปลรับค่าเดือนกับวัน
step 2:ตั้งเงื่อนไขเป็นเดือนที่3หรือน้อยกว่านั้น
step 3:ถ้าเป็นเดือนที่หาร3ลงตัวและวันที่21 ให้เปลี่ยนฤดู
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ตั้งตัวแปลรับเดือนและวัน จากนั้นสร้างเงื่อนไขให้ตรงตามโจทย์และแสดงฤดูออกมา
```
