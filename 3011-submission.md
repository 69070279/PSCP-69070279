...
```text
โจทย์ ต้องการให้รับแม่สีมา และตอบตามที่สีมันผสมกัน

input:
รับค่าแม่สีมา2ค่า

output:
เมื่อแม่สีนั้นผสมกันจะได้สีอะไรตามมา

Constraints:
เมื่อผสมตามสีแม่สี จะได้าสีที่ตายตัว  และหากผสมสีอื่นจะต้องตอบerror
```
...
```text
step 1: กำหนดตัวแปลรับค่า2ค่า
step 2:ตั้งif-elif-else ให้ทำตามข้อกำหนด
step 3:กำหนดoutputตามที่โจทย์กำหนด
step 4:หากนอกเหนือแสดงerror
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก แต่มีการเพิ่มเติมในตัวของif-elif-elseขึ้นมา เพราะตอนแรกใส่ไม่ครบtestcase
```
...
```text
เพราะเป็นตัวอย่างที่โจทย์กำหนดมาให้ ถ้าผิดตัวอื่นก็ผิด
```
...
```text
เพื่อดูว่าcodeตัวเองเขียนถูกมั้ย ขึ้นerrorรึเปล่า
```
...
```text
พี่TA คอยใบ้เงื่อนไขที่ยังไม่ได้เพิ่ม
เพื่อน ช่วยกันคิดว่าจะต้องมีอะไรบ้างในcodeเพื่อให้ออกมาตามที่คาดไว้
```

คุณยังทำอะไรด้วยตนเอง

```text
กลับหอมาเขียนเอง และทบทวนสิ่งที่ทำในคู่pair
```
